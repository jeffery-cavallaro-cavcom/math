...
It is tempting to think that \(\e\to0\) forces \(\d\to0\) and that the bounding box converges on the point
\(a,L\); however, this is not always the case.
